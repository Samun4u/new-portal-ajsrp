...
if (!function_exists("getMessage")) {
    function getMessage($input = null)
    {
        $output = [
            ...
            ALREADY_EXIST => __("Already exist, Please try again"),
        ];
...
if (!function_exists("accountStatus")) {
    function accountStatus($input = null)
    {
        $output = [
            STATUS_PENDING => __("Pending"),
            STATUS_ACTIVE => __("Active"),
...
function getPaymentServiceClass($input = null)
{
    $output = array(
        ...
        CASH => 'App\Http\Services\Payment\CashService',
    );
    if (is_null($input)) {
        return $output;
    } else {
...
if (!function_exists("getOrderStatusName")) {
    ...
    {
        $output = [
            WORKING_STATUS_WORKING => __('Working'),
            WORKING_STATUS_COMPLETED => __('Completed'),
...
function customEmailTempFields($type = null)
{
    ...
    else if ($type == 'reviewer-application') {
        $data = [
            '{{full_name}}' => '',
            '{{email}}' => '',
            '{{institution}}' => '',
        ];
    }else if ($type == 'order-task') {
        $data = [];
    }else if ($type == 'order') {
        $data = [];
    }else if ($type == 'common'){
    ...
    }else if ($type == 'article-accepted-for-publication'){
        $data = [
            '{{authorName}}' => '',
            '{{articleTitle}}' => '',
        ];
    }else if ($type == 'abstract-order'){
        $data = [
            '{{author_name}}' => '',
            '{{order_id}}' => '',
        ];
    }else if ($type == 'book-submit'){
        $data = [
          '{{author_name}}' => '',
          '{{book_title}}' => '',
          '{{book_description}}' => '',

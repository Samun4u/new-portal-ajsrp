...
const SUBMISSION_REVIEWER_NOTE_PRIORITY_LOW = 1;
const SUBMISSION_REVIEWER_NOTE_PRIORITY_MEDIUM = 2;
const SUBMISSION_REVIEWER_NOTE_PRIORITY_HIGH = 3;
...
const USER_ROLE_REVIEWER = 5;

const  USER_ROLE_INITIAL_EVALUATOR = 6;
const  USER_ROLE_FINANCIAL_MANAGER = 7;
const  USER_ROLE_PEER_REVIEWER_MANAGER = 8;
const  USER_ROLE_PUBLISHER = 9;
const  USER_ROLE_MARKETER = 10;
...
const ALREADY_EXIST = "Already exist, Please try again";
...
const JOURNAL_CATEGORY_STATUS_ACTIVE = 'active';
const JOURNAL_CATEGORY_STATUS_INACTIVE = 'inactive';

const JOURNAL_STATUS_ACTIVE = 'active';
const JOURNAL_STATUS_INACTIVE = 'inactive';

//submission approval status
const SUBMISSION_ORDER_STATUS_PENDING = 'pending';
const SUBMISSION_ORDER_STATUS_INCOMPLETE = 'incomplete';
const SUBMISSION_ORDER_STATUS_UNDER_PRIMARY_REVIEW = 'under_primary_review';
const SUBMISSION_ORDER_STATUS_INITIAL_ACCEPTED = 'initial_accepted';
const SUBMISSION_ORDER_STATUS_INITIAL_REJECTED = 'initial_rejected';
const SUBMISSION_ORDER_STATUS_PENDING_PAYMENT = 'pending_payment';
const SUBMISSION_ORDER_STATUS_PAYMENT_CONFIRMED = 'payment_confirmed';
const SUBMISSION_ORDER_STATUS_PAYMENT_FAILED = 'payment_failed';
const SUBMISSION_ORDER_STATUS_UNDER_PEER_REVIEW = 'under_peer_review';
const SUBMISSION_ORDER_STATUS_ACCEPTED_WITH_REVISIONS = 'accepted_with_revisions';
const SUBMISSION_ORDER_STATUS_PEER_REJECTED = 'peer_rejected';
const SUBMISSION_ORDER_STATUS_ACCEPTED ='accepted';
const SUBMISSION_ORDER_STATUS_PROOFREADING ='proofreading_&_metadata';
const SUBMISSION_ORDER_STATUS_PAYMENT_APC ='payment_(APC)_-_invoice';
const SUBMISSION_ORDER_STATUS_ACCEPTANCE_CERTIFICATE ='acceptance_certificate';
const SUBMISSION_ORDER_STATUS_FINAL_PRODUCTION ='final_production_(galley)';
const SUBMISSION_ORDER_STATUS_ACCEPTED_FOR_PUBLICATION ='accepted_for_publication';
const SUBMISSION_ORDER_STATUS_PUBLISHED ='published';
const SUBMISSION_ORDER_STATUS_ARCHIVED ='archived';
const SUBMISSION_ORDER_STATUS_IN_FOLLOWUP ='in_followup';

//reviewer submission status
const SUBMISSION_REVIEWER_ORDER_STATUS_PENDING_REVIEW = 'pending_review';
const SUBMISSION_REVIEWER_ORDER_STATUS_IN_PROGRESS = 'in_progress';
const SUBMISSION_REVIEWER_ORDER_STATUS_COMPLETED = 'completed';

//reviewer submission admin status
const SUBMISSION_REVIEWER_ORDER_ADMIN_STATUS_UNDER_REVIEW = 'under_review';
const SUBMISSION_REVIEWER_ORDER_ADMIN_STATUS_ACCEPTED = 'accepted';
const SUBMISSION_REVIEWER_ORDER_ADMIN_STATUS_REJECTED = 'rejected';
const SUBMISSION_REVIEWER_ORDER_ADMIN_STATUS_PUBLISHED = 'published';

//submit book status
const SUBMISSION_BOOK_STATUS_PENDING = 'pending';
const SUBMISSION_BOOK_STATUS_ACCEPTED = 'accepted';
const SUBMISSION_BOOK_STATUS_REJECTED = 'rejected';
const SUBMISSION_BOOK_STATUS_PUBLISHED ='published';

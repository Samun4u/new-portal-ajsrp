...
class UserService
{
    ...
    public function userBasicDetails($id){
        return UserDetails::where('user_id', $id)->first();
    }
    public function professionalDetails($id){
        return ClientProfessionalDetails::where('user_id', $id)->first();
    }

    public function publicationDetails($id){
        return ClientPublicationDetails::where('user_id', $id)->get();
    }

    public function researchInformation($id){
        return ClientResearchInformation::where('user_id', $id)->first();
    }

    public function educationQualification($id){
        return EducationQualification::where('user_id', $id)->get();
    }
}

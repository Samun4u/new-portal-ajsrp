...
class SubmissionReviewerNoteController extends Controller
{
    ...
    private $submissionReviewerNoteService;

    public function __construct()
    {
        $this->submissionReviewerNoteService = new SubmissionReviewerNoteService;
    }
    ...
    public function addNew($order_id)
    {
        ...
        return view('user.submission_reviewer_note.add-new', $data);
    }
    ...
    public function edit($id)
    {
        ...
        $data['activeOrder'] = 'active';
        $data['ticketDetails'] = $this->submissionReviewerNoteService->ticketDetails(decrypt($id));
        $data['clientOrderList'] = ClientOrder::where([
            'client_id' => auth()->id(),
    ...
    public function details($id)
    {
        ...
        $data['ticketDetails'] = $this->submissionReviewerNoteService->ticketDetails(decrypt($id));
        $data['ticketConversations'] = $this->submissionReviewerNoteService->ticketConversations(decrypt($id));
        $data['clientOrder'] = ClientOrder::where([
        ...
        return view('user.submission_reviewer_note.details', $data);
    }


    public function store(SubmissionReviewerRequest $request)
    {
        return $this->submissionReviewerNoteService->store($request);
    }
    ...
    public function conversationsStore(Request $request)
    {
        ...
        return $this->submissionReviewerNoteService->conversationsStore($request);
    }
    ...
    public function delete($id)
    {
        try {
            DB::beginTransaction();
            $ticketData = SubmissionReviewerNotes::where('id', decrypt($id))->first();
            $ticketData->delete();
            DB::commit();

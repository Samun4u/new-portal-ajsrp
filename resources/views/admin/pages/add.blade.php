                            ...
                            <div class="bd-b-one bd-c-stroke pb-40 mb-36">
                                <div class="row rg-20">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea name="content" id="tinymce-content" class="form-control zForm-control" rows="10"></textarea>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <select class="sf-select-without-search" name="role_id" required>
                                            ...
                                            <option value="4">{{ __('Clients') }}</option>
                                            <option value="5">{{ __('Reviewers') }}</option>
                                        </select>
                                    </div>

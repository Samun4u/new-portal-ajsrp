        ...
        <div class="p-sm-30 p-15">
            <div class="max-w-894 m-auto">
                ...
                <div class="d-flex justify-content-between align-items-center g-10 pb-12">
                    <!--  -->
                    <h4 class="fs-18 fw-600 lh-20 text-title-black">{{ __('Add Journal') }}</h4>
                    <!--  -->
                </div>
                                    ...
                                    <select class="sf-select-two" name="journal_service_id">
                                        ...
                                        @foreach ($serviceList as $service)
                                            <option value="{{ $service->id }}">{{ $service->service_name }}
                                                ({{ currentCurrency('symbol') }}{{ $service->price }})</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-12">
                                    ...
                                    <select class="sf-select-two" name="status">
                                        <option value="{{ JOURNAL_STATUS_ACTIVE }}">{{ __('Active') }}</option>
                                        <option value="{{ JOURNAL_STATUS_INACTIVE }}">{{ __('Inactive') }}</option>
                                    </select>
                                </div>
                                <div class="col-12">

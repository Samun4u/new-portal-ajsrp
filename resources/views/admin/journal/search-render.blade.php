                                    ...
                                    <div class="col-xxl-3 col-md-4 col-sm-6">
                                        <div class="p-16 bd-ra-10 bg-white">
                                            ...
                                            <div class="bd-b-one bd-c-stroke pb-14 mb-11">
                                                <!--  -->
                                                <h4 class="fs-15 fw-600 lh-18 text-title-black pb-9">{{$journal->title}}</h4>
                                                <!--  -->
                                                <h4 class="fs-15 fw-500 lh-18 text-para-text"><a href="{{$journal->website}}" target="_blank">Website</a></h4>
                                                <h4 class="fs-15 fw-500 lh-18 text-para-text">{{currentCurrency('symbol')}}{{$journal->charges}}</h4>
                                                <h4 class="fs-15 fw-500 lh-18 text-para-text">{{$journal->journal_category->name}}</h4>
                                ...
                                <table class="table zTable zTable-last-item-right" id="serviceListTable">
                                    ...
                                    @foreach($journalList as $journal)
                                        <tr>
                                            ...
                                            <td><p class='text-nowrap fs-12 fw-500 lh-15 text-para-text'>{{$journal->title}}</p></td>
                                            <td><p class='fs-12 fw-500 lh-15 text-para-text'><a href="{{$journal->website}}" target="_blank">Website</a></p></td>
                                            <td><p class='fs-12 fw-500 lh-15 text-para-text'>{{currentCurrency('symbol')}}{{$journal->charges}}</p></td>
                                            <td><p class='fs-12 fw-500 lh-15 text-para-text'>{{$journal->journal_category->name}}</p></td>

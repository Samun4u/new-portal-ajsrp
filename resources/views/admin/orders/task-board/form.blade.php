<div class="row rg-20">
    ...
    <div class="col-12">
        <div class="zForm-wrap-checkbox-2">
            <input type="checkbox" class="form-check-input" id="has_client_access" value="1"
                   name="has_client_access" {{ ($orderTask->client_access ?? false) ? 'checked' : '' }}>
            <label for="has_client_access">{{ __('Has Client Access') }}</label>
        </div>
    </div>
</div>

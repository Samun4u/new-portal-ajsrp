        ...
        <div class="row">
            ...
            <div class="col-lg-8 pe-lg-0">
                ...
                <div class="py-16 mb-16 bd-b-one bd-c-stroke pe-lg-2">
                    <h4 class="fs-24 fw-600 text-title-black pb-20">{{$orderTask->task_name}}</h4>
                    <p class="fs-18 fw-500 text-title-black pb-16">{{__('Description')}}</p>
                                        ...
                                        <div class="content-chat-message-user">
                                            ...
                                            <div class="footer-chat-message-user file-input-wrapper">
                                                <form method="POST" class="ajax reset"
                                                      action="@if(auth()->user()->role != USER_ROLE_CLIENT) {{ route('admin.client-orders.task-board.conversation.store', [$order->id, $orderTask->id]) }} @else {{ route('user.orders.task-board.conversation.store', [$order->id, $orderTask->id]) }} @endif"
                                ...
                                <div class="bd-ra-10 bg-body-bg overflow-hidden"
                                    ...
                                    <div class="content-chat-message-user-wrap">
                                        <div class="content-chat-message-user">
                                            ...
                                            <div class="footer-chat-message-user file-input-wrapper">
                                                <form method="POST" class="ajax reset"
                                                      action="{{ route('admin.client-orders.task-board.conversation.store', [$order->id, $orderTask->id]) }}"
                                                      data-handler="chatResponse">
                                                    @csrf
                                                    <!-- Attachment preview -->
                                                    <div class="files-area">
            ...
            <div class="col-lg-4 ps-lg-0">
                <div class="bd-l-one bd-c-stroke h-100">
                    <div class="bd-b-one bd-c-stroke p-16">
                        <p class="fs-18 fw-500 text-title-black pb-16">{{__('Progress')}}</p>
                    ...
                    <div class="bd-b-one bd-c-stroke p-16">
                        <div class="d-flex align-items-center g-10 pb-16">
                            <p class="fs-18 fw-500 text-title-black">{{__('Properties')}}</p>
                            @if(auth()->user()->role != USER_ROLE_CLIENT)
                                <button type="button" class="border-0 bg-transparent text-title-black fs-14"
                                        onclick="openEditModal('{{ route('admin.client-orders.task-board.edit', [$orderTask->client_order_id, $orderTask->id]) }}')">
                                    <i
                    ...
                    <div class="p-16">
                        <div class="d-flex align-items-center g-10 pb-16">
                            <h4 class="fs-18 fw-500 text-title-black">{{__('Attachments')}}</h4>
                            <span
                                class="w-16 h-16 rounded-circle bg-stroke fs-12 fw-500 text-title-black d-flex justify-content-center align-items-center">{{count($orderTask->attachments)}}</span>
                        </div>
                            ...
                            @foreach($orderTask->attachments as $attachment)
                                <li class="bd-one bd-c-stroke bd-ra-6 p-10 d-flex align-items-center g-10">
                                    <div class="flex-grow-1 d-flex align-items-center g-10">
                                        ...
                                        <div class="">
                                            <h4 class="fs-14 fw-400 lh-17 text-title-black">{{getFileData($attachment->filemanager->id, 'file_name')}}</h4>
                                    ...
                                    <button
                                        onclick="deleteAttachment('{{ route('admin.client-orders.task-board.delete-attachment', [$orderTask->client_order_id, $orderTask->id, $attachment->file]) }}', '{{ route('admin.client-orders.task-board.view', [$orderTask->client_order_id, $orderTask->id]) }}')"

                ...
                <table class="table zTable zTable-last-item-right" id="orderTable-all">
                    <thead>
                        <tr>
                            ...
                            <th>
                                <div class="text-nowrap">{{__('Article Title')}}</div>
                            </th>
                            <th>
                            ...
                            <th>
                                <div class="text-nowrap">{{__('Order Status')}}</div>
                            </th>
                            <th>
...
<input type="hidden" id="client-order-list-route" value="{{ route('admin.client-orders.list', request()->query()) }}">
@endsection

@push('script')
<script src="{{ asset('admin/custom/js/client-orders.js?t=' . time()) }}"></script>
@endpush

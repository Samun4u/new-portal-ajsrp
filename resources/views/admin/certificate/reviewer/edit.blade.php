        ...
        <div class="p-sm-30 p-15">
            <div class="max-w-894 m-auto">
                ...
                <form class="ajax reset" action="{{route('admin.certificate.reviewer.store')}}" method="POST"
                    ...
                    @csrf
                    <input type="hidden" name="id" value="{{$reviewerCertificate->id}}">
                                ...
                                <div class="row rg-20">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <select class="sf-select-without-search" name="client_order_id" required>
                                            ...
                                            @foreach ($orderList as $order)
                                                <option value="{{$order->order_id}}" {{$reviewerCertificate->client_order_id === $order->order_id ? 'selected' : ''}}>{{$order->order_id }} {{ $order->client_id ? '('.getEmailByUserId($order->client_id).')' : '' }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <input type="hidden" value='{{ route("admin.certificate.reviewer.order-details") }}' id="orderDetailsUrl">
                                     <input type="hidden" id="reviewerCertificateType" value="edit">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <select id="reviewer_id" class="sf-select-without-search" name="reviewer_id" required>
                                            ...
                                            @foreach ($reviewerList as $reviewer)
                                                <option value="{{ $reviewer->id }}" {{$reviewerCertificate->reviewer_id == $reviewer->id ? 'selected' : ''}}>{{$reviewer->name.' ('.$reviewer->email.')'}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input name="title" type="text" class="form-control zForm-control"
                                               id="addTitle" placeholder="{{__('Enter Title')}}" value="{{$reviewerCertificate->title}}" required/>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input name="affiliations" type="text" class="form-control zForm-control"
                                               id="addAffiliations" placeholder="{{__('Enter Affiliations')}}" value="{{$reviewerCertificate->affiliations}}" required/>
                                    </div>
                                    <div class="col-12">
                                        ...
                                        <input name="paper_title" type="text" class="form-control zForm-control"
                                               id="addPaperTitle" placeholder="{{__('Enter Paper Title')}}"  value="{{$reviewerCertificate->paper_title}}" required/>
                                    </div>
                                    <div class="col-12">
                                        ...
                                        <input name="journal_name" type="text" class="form-control zForm-control"
                                               id="addJournalName" placeholder="{{__('Enter Journal Name')}}" value="{{$reviewerCertificate->journal_name}}" required/>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <select class="sf-select-without-search" name="language" required>
                                            <option value="en" {{$reviewerCertificate->language == 'en' ? 'selected' : ''}}>{{ __('English') }}</option>
                                            <option value="ar" {{$reviewerCertificate->language == 'ar' ? 'selected' : ''}}>{{ __('Arabic') }}</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input name="chief_editor_name" type="text" class="form-control zForm-control"
                                               id="chief_editor_name" placeholder="{{__('Enter Editor Name')}}" value="{{$reviewerCertificate->chief_editor_name}}"/>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input name="chief_editor_name_ar" type="text" class="form-control zForm-control"
                                               id="chief_editor_name_ar" placeholder="{{__('Enter Editor Name in Arabic')}}" value="{{$reviewerCertificate->chief_editor_name_ar}}"/>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        @if($reviewerCertificate->signature_image)
                                            <div class="mt-2">
                                                <img src="{{ asset(getFileUrl($reviewerCertificate->signature_image)) }}" alt="Signature" style="max-height: 50px;">
                                            </div>
                                        @endif
                                    </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        @if($reviewerCertificate->logo_image)
                                            <div class="mt-2">
                                                <img src="{{ asset(getFileUrl($reviewerCertificate->logo_image)) }}" alt="Logo" style="max-height: 50px;">
                                            </div>
                                        @endif
                                    </div>
...
@push('script')
    ...
    <script src="{{ asset('admin/custom/js/reviewer_certificate.js?t=' . time()) }}"></script>
@endpush

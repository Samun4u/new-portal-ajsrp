                    ...
                    <table class="table zTable zTable-last-item-right" id="invoiceTable-all">
                        <thead>
                            <tr>
                                ...
                                <th>
                                    <div class="text-nowrap">{{__('Invoice')}}</div>
                                </th>
                                <th>
                                ...
                                <th>
                                    <div class="text-nowrap">{{__('Proofreading')}}</div>
                                </th>
                                <th>
                                    <div>{{__('Status')}}</div>
                                </th>
...
<div class="modal fade" id="showPaymentModal" tabindex="-1" aria-labelledby="showPaymentModal" aria-hidden="true">
    <div class="modal-dialog modal-md modal-dialog-centered">
        <div class="modal-content border-0 overflow-visible bd-ra-4 p-25 invoice-content-wrap">
...
<input type="hidden" id="client-invoice-list-route" value="{{ route('admin.client-invoice.list', request()->query()) }}">

@endsection


@push('script')
<script src="{{ asset('admin/custom/js/client-invoice.js?t=' . time()) }}"></script>
@endpush

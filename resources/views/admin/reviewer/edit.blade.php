    ...
    <div data-aos="fade-up" data-aos-duration="1000" class="overflow-x-hidden">
        <div class="p-sm-30 p-15">
            <div class="max-w-894 m-auto">
                ...
                <!--  -->
                <form class="ajax reset" action="{{route('admin.reviewer.store')}}" method="POST"
                      enctype="multipart/form-data" data-handler="commonResponse">
                    @csrf
                    <input type="hidden" name="id" value="{{$reviewerDetails->id}}">
                                ...
                                <div class="row rg-20">
                                    <div class="col-12">
                                        ...
                                        <input name="client_name" type="text" class="form-control zForm-control"
                                               id="addClientName" placeholder="{{__('Enter Name')}}" value="{{$reviewerDetails->name}}"/>
                                    </div>
                                    <div class="col-12">
                                        ...
                                        <input name="client_email" type="email" class="form-control zForm-control"
                                               id="addClientEmail" placeholder="{{__('Enter Email')}}" value="{{$reviewerDetails->email}}"/>
                                    </div>
                                    <div class="col-12">
                                        <div
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input name="client_phone_number" type="number"
                                               ...
                                               placeholder="{{__('Enter Phone Number')}}" value="{{$reviewerDetails->mobile}}"/>
                                    </div>
                                    <div class="col-12">
                                        <div
                                            class="d-flex justify-content-between align-items-center flex-wrap g-8 pb-8">
                                        ...
                                        <input name="client_company_name" type="text" class="form-control zForm-control"
                                               id="addClientCompany" placeholder="{{__('Enter Company')}}" value="{{$reviewerDetails->company_name}}"/>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <select class="sf-select-without-search" name="status">
                                            <option {{ $reviewerDetails->status == STATUS_ACTIVE ? 'selected' : '' }} value="{{STATUS_ACTIVE}}">{{ __('Active') }}</option>
                                            <option {{ $reviewerDetails->status == STATUS_DEACTIVATE ? 'selected' : '' }} value="{{STATUS_DEACTIVATE}}">{{ __('Deactivate') }}</option>
                                        </select>
                                    </div>
                                        ...
                                        <div class="d-flex align-items-center g-10">
                                            ...
                                            <div class="servicePhotoUpload d-flex flex-column g-10 w-100">
                                                ...
                                                <div class="max-w-150 flex-shrink-0">
                                                    <img src="{{getFileUrl($reviewerDetails->image)}}" class="p-10"/>

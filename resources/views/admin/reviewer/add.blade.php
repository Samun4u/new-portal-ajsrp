        ...
        <div class="p-sm-30 p-15">
            <div class="max-w-894 m-auto">
                ...
                <form class="ajax reset" action="{{route('admin.reviewer.store')}}" method="POST"
                      ...
                      data-redirect-url="{{route('admin.reviewer.list')}}">
                    @csrf
                        ...
                        <div class="max-w-713 m-auto py-sm-52 py-15">
                            ...
                            <div class="bd-b-one bd-c-stroke pb-40 mb-36">
                                <div class="row rg-20">
                                    ...
                                    <div class="col-12">
                                        <label for="addClientCompany" class="zForm-label">{{__('Company Name')}}</label>
                                    ...
                                    <div class="col-12">
                                        <label for="rtl" class="zForm-label">{{ __('Status') }}</label>

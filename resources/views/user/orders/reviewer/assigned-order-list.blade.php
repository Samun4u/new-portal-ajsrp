...
@if($orderCount > 0)
    ...
    <input type="hidden" id="client-order-list-route" value="{{ route('user.orders.reviewer.assigned.list') }}">
@else
    <div data-aos="fade-up" data-aos-duration="1000" class="p-sm-30 p-15">
...
@push('script')
<script src="{{ asset('user/custom/js/reviewer-assigned-orders.js') }}"></script>
@endpush

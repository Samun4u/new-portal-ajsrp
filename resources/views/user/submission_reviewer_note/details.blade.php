    ...
    <div data-aos="fade-up" data-aos-duration="1000" class="p-sm-30 p-15 overflow-x-hidden">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap g-10 pb-20">
            ...
            <div class="d-flex flex-wrap g-10">
               {{-- <a href="{{route('user.submission-reviewer-notes.edit', encrypt($ticketDetails->id))}}" class="py-10 px-26 d-flex align-items-center g-12 fs-15 fw-600 lh-25 text-white bg-main-color bd-one bd-c-main-color bd-ra-8">
                    <div class="d-flex">
        ...
        <div class="row justify-content-center rg-20">
            <div class="col-xl-3 col-lg-4 col-sm-6">
                <div class="bd-one bd-c-stroke bd-ra-10 p-sm-25 p-15 bg-white">
                    ...
                    <ul class="zList-pb-18 bd-b-one bd-c-stroke pb-18 mb-18">
                       ...
                       {{--  @if($ticketDetails->order_id != "general_inquery")
                        <li>
            ...
            <div class="col-xl-9 col-lg-8">
                <div class="d-flex flex-column rg-15">
                    ...
                    @include('user.submission_reviewer_note.conversation')
                </div>
            </div>
        </div>
    </div>
...
@push('script')
    <script src="{{ asset('user/custom/js/submission_reviewer_note.js') }}"></script>
@endpush

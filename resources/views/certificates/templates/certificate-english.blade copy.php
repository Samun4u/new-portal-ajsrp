    ...
    <div class="certificate-wrapper">
        <div class="certificate-container">
            ...
            <div class="content-layer">
                ...
                <div class="content">
                    <p>
                        This certificate officially attests that the manuscript entitled <span class="highlight">"{{ $certificate->paper_title }}"</span> has been
                        formally accepted for publication in the <span class="highlight">{{ $journal->title ?? $journal->name ?? 'Journal' }}</span>,
                    ...
                    <div class="manuscript-details">
                        ...
                        <div class="detail-grid">
                            ...
                            <div class="detail-item">
                                ...
                                <span class="detail-value">Volume {{ $volume }}, Issue {{ $issue }}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="verification-box">
                        ...
                        <div class="qr-code-container">
                            <img src="data:image/png;base64,{{ $qrCode }}" alt="QR Code" style="width: 140px; height: 140px; border: 3px solid var(--accent); padding: 5px;">
                        </div>
                ...
                <div class="signature-section">
                    ...
                    <div class="official-seal">
                         @if($stampImage)
                            <img src="{{ $stampImage }}" style="width: 100%; height: 100%; object-fit: contain; border-radius: 50%;">
                        @else

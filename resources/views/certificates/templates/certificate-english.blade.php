...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:wght@400;600;700&family=Montserrat:wght@400;600;800&family=Playfair+Display:wght@700;900&display=swap"
        rel="stylesheet">
    <style>
        :root {
            --ink: #0a1628;
            ...
            function downloadAsPdf() {
                ...
                html2canvas(element, {
                    ...
                    const dataUrl = canvas.toDataURL('image/jpeg',
                        0.9); // Use JPEG for slightly smaller size if needed, or PNG
    ...
    <div class="certificate-wrapper" id="certificate-content">
        <div class="certificate-container">
            ...
            <div class="content-layer">
                ...
                <div class="content">
                    <p>
                        This certificate officially attests that the manuscript entitled
                        <strong>"{{ $certificate->paper_title }}"</strong> has been
                        formally accepted for publication in the
                        <strong>{{ $journal->title ?? ($journal->name ?? 'Journal') }}</strong>,
                        following rigorous peer-review and editorial evaluation procedures.
                    </p>

                    <p>
                        Based upon comprehensive reviewers' assessments and the unanimous decision of the Editorial
                        Board, the manuscript
                        has been determined to meet the highest scholarly, methodological, and ethical standards of this
                        journal.
                        No further substantive scientific revisions are required. The manuscript will proceed directly
                        to the production
                    ...
                    <div class="manuscript-details">
                        ...
                        <div class="detail-grid">
                            ...
                            <div class="detail-item">
                                ...
                                <span class="detail-value">Volume {{ $volume }}, Issue
                                    {{ $issue }}</span>
                            </div>
                        </div>
                    </div>
                ...
                <p>
                    The corresponding author will receive detailed instructions regarding copyright transfer
                    agreements,
                    author licensing options, proof corrections, and open access policies. Publication fees, if
                    applicable,
                    will be communicated separately per the journal's standard author agreement.
                </p>

                <p>
                    This certificate serves as official documentation of manuscript acceptance and may be used for
                    academic,
                    professional, or institutional purposes. The certificate remains valid contingent upon
            ...
            <div class="signature-section">
                ...
                <div class="signature-block">
                    ...
                    <div class="signature-name">{{ $managingEditor ?? 'Managing Editor' }}</div>

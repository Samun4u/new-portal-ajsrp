...
class UserSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        User::insert([
            ['uuid' => '12345', 'name' => 'Super Administrator Doe', 'mobile' => '0', 'role' => USER_ROLE_SUPER_ADMIN, 'email' => 'sadmin@gmail.com', 'password' => Hash::make(123456), 'status' => USER_STATUS_ACTIVE, 'google2fa_secret' => $google2fa->generateSecretKey(), 'email_verification_status' => 1, 'phone_verification_status' => 1, 'tenant_id' => ''],
